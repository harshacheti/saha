...
class CategoryVerticalListView extends StatefulWidget {
  const CategoryVerticalListView({Key key, this.callBack}) : super(key: key);

  final Function callBack;
  @override
  _CategoryVerticalListViewState createState() => _CategoryVerticalListViewState();
}
...
class CategoryView extends StatelessWidget {
  ...
  final CategoryVerticalListView category;
